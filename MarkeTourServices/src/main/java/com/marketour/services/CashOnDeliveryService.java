...
public class CashOnDeliveryService {
	...
	public CashOnDeliveryService() {
		repository = new com.marketour.persistence.Repository<ContraEntrega>(
				ContraEntrega.class);
	}
	...
	@PUT
	@Produces(MediaType.APPLICATION_JSON)
	public Response Persist(ContraEntrega entity) {
		return Response.status(200).header("Access-Control-Allow-Origin", "*")

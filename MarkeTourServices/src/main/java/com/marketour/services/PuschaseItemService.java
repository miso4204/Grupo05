...
@Path("/PuschaseItemService")
@Produces(MediaType.APPLICATION_JSON)
public class PuschaseItemService {

	@SuppressWarnings("rawtypes")
	private Repository repository;

	public PuschaseItemService() {
		repository = new com.marketour.persistence.Repository<ItemCompra>(
				ItemCompra.class);
	}
	...
	@PUT
	@Produces(MediaType.APPLICATION_JSON)
	public Response Persist(ItemCompra entity) {
		return Response.status(200).header("Access-Control-Allow-Origin", "*")

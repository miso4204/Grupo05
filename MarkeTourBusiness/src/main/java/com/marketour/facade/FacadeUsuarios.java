...
public class FacadeUsuarios {
	public static java.lang.Boolean Autenticar(
			com.marketour.business.Credenciales credenciales) {
	...
	public static java.lang.Boolean CambiarContrasena(
			com.marketour.business.Credenciales credenciales) {
		com.marketour.business.functions.FactoryUsers users = new com.marketour.business.functions.FactoryUsers(
				"Usuario");
	...
	public static java.lang.Boolean CambiarDireccion(
	...
	public static com.marketour.business.Administrador ConsultarAdministrador(
			int id) {
		com.marketour.business.functions.FactoryUsers users = new com.marketour.business.functions.FactoryUsers(
				"Administrador");
	...
	public static java.util.List<com.marketour.business.Cliente> ConsultarClientes() {
		com.marketour.business.functions.FactoryUsers users = new com.marketour.business.functions.FactoryUsers(
				"Cliente");
		return ((java.util.List<com.marketour.business.Cliente>) ((java.util.List<?>) (users
				.ConsultarLista())));
	}
	...
	public static java.lang.Object ConsultarMonedaTodos() {
		...
		com.marketour.persistence.Repository<com.marketour.domain.Moneda> repository = new com.marketour.persistence.Repository<com.marketour.domain.Moneda>(
	...
	public static java.util.List<com.marketour.business.Usuario> ConsultarUsuarios() {
		com.marketour.business.functions.FactoryUsers users = new com.marketour.business.functions.FactoryUsers(
				"");
		return ((java.util.List<com.marketour.business.Usuario>) ((java.util.List<?>) (users
				.ConsultarLista())));
	}

	public static com.marketour.business.Cliente RegistrarCliente(
			com.marketour.business.Cliente business) {
		...
		return com.marketour.facade.FacadeUsuarios.ConsultarCliente(domain
				.getId());
	}

	public static java.lang.Object RegistrarProveedor(
			com.marketour.business.Proveedor business) {
		...
		boolean update = domain != null;
		domain = repository.FindById(business.getId());
		domain = com.marketour.business.Proveedor
				.ConvertToBDProveedor(business);
		domain.setUsuario(domainUser);
		if (update)
			repository.Update(domain);
		else
		...
		return com.marketour.facade.FacadeUsuarios.ConsultarProveedor(domain
				.getId());
	}

	public static com.marketour.business.Usuario RegistrarUsuario(
			com.marketour.business.Usuario business) {
		...
		if ((business.getId()) > 0) {
			domain = repository.FindById(business.getId());
			domain = com.marketour.business.Usuario.ConvertToBDUsuario(
					business, domain);
			...
			repository.Update(domain);
			// Pattern Variability
			Credenciales credential = new Credenciales();
			credential.setContrasena(business.getPassword());
			credential.setUsuario(business.getLogin());
			CambiarContrasena(credential);
			CambiarDireccion(business);
		} else {
			domain = com.marketour.business.Usuario
					.ConvertToBDUsuario(business);
			if ((business.getIdMoneda()) > 0) {
				domain.setMoneda(repoCurrency.FindById(business.getIdMoneda()));
			}
			repository.Save(domain);
		}
		return com.marketour.facade.FacadeUsuarios.ConsultarUsuario(domain
				.getId());
	}
